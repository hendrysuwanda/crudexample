            ...
            <form method="post" action="/contact/add">
		        <fieldset>
          			...
          			<div class="clearfix">
	            		...
	            		<div class="input">
	              			<input class="xlarge" id="lastName" name="lastName" size="30" type="text" />
	            		</div>
          			</div><!-- /clearfix -->
					...
					<div class="well">
						<input type="submit" class="btn primary" value="Save">&nbsp;<button type="reset" class="btn" onclick="location.href='contacts.jsp'">Cancel</button>
					</div>
        		</fieldset>
      		</form>
          </div> 
